...
--        INSERT INTO NhanVien (MaNhanVien , HoVaTen , SDT , Email , CCCD , DiaCHi , ChucVu , GioiTinh , HinhThucLamViec)
--        VALUES (@MaNhanVien, @HoTen, @SDT, @Email, @CCCD , @DiaChi , @ChucVu , @GioiTinh , @HinhThucLamViec);
